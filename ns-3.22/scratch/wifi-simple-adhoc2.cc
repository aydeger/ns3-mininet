...
int main (int argc, char *argv[])
{
  ...
  std::string m_protocol = "ns3::UdpSocketFactory";

  InetSocketAddress dst = InetSocketAddress (i.GetAddress (1), m_dest_port);
  Ptr<Node> source = c.Get(0);
  Ptr<Node> sinkNode = c.Get(1);
