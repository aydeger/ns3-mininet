...
public:
  ...
  void AddUeAccessList (Ipv4Address ip1, Ipv4Address ip2);
...
public:
  ...
  */
  ...
  /*
   * IP access list, this is used when UE is the gateway to other network
  */
  std::map<Ipv4Address, Ipv4Address> m_UeAccessListByDestIp;
};
