  ...
  : m_gtpuUdpPort (2152)  // fixed by the standard
{
  ...
  //
  m_sgwPgwApp->AddUeAccessList (Ipv4Address ("7.1.0.1"), Ipv4Address ("7.0.0.2"));  
  m_sgwPgwApp->AddUeAccessList (Ipv4Address ("7.1.0.2"), Ipv4Address ("7.0.0.2"));  
  m_sgwPgwApp->AddUeAccessList (Ipv4Address ("7.2.0.1"), Ipv4Address ("7.0.0.3"));
  m_sgwPgwApp->AddUeAccessList (Ipv4Address ("7.2.0.2"), Ipv4Address ("7.0.0.3"));
  m_sgwPgwApp->AddUeAccessList (Ipv4Address ("7.3.0.1"), Ipv4Address ("7.0.0.4"));
  m_sgwPgwApp->AddUeAccessList (Ipv4Address ("7.3.0.2"), Ipv4Address ("7.0.0.4"));
  m_sgwPgwApp->AddUeAccessList (Ipv4Address ("7.4.0.1"), Ipv4Address ("7.0.0.5"));
  m_sgwPgwApp->AddUeAccessList (Ipv4Address ("7.4.0.2"), Ipv4Address ("7.0.0.5"));
  //
}
